...
TOOLS = [
    ...
    # ── OS Dashboard ───────────────────────────────────────────────────────────
    {
        ...
        "description": (
            "Write cold-calling outreach metrics extracted from the Cold Calling Metrics Google Sheet "
            "directly into the OS dashboard and Analytics panel. Updates sales_stats.json, which feeds "
            "the outreach/calling side of the Analytics panel (cold-calling only — shows/closes/revenue/"
